...
import (
	...
	"github.com/qs-lzh/proglog/internal/agent"
	"github.com/qs-lzh/proglog/internal/config"
)
...
func (c *cli) setupConfig(cmd *cobra.Command, args []string) error {
	...
	if err = viper.ReadInConfig(); err != nil {
		// it's ok if config file doesn'tn exist
