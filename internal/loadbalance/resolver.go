...
// resolver.Builder.Build is called automatically when a gRPC Dial occurs
// set up an client connection to the server so the resolver can call the GetServers API
